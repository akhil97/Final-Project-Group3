...
def main():
    ...
    with tab1:
        ...
        model_choice = st.sidebar.selectbox("Choose a Model", ["BERT", "GPT-3", "XLNet", "GPT-3 Legal", "BERT Legal", "Legal Transformer", "BERT", "RoBERTa", "Legal-BERT"])
    ...
    with tab2:
        ...
        st.write("## Description")
        st.write("This advanced tool is designed to classify legal documents into specific categories and predict outcomes based on their content. It's useful for legal professionals who need quick insights into a document's nature and potential legal outcomes.")
        ...
        st.write("3. **Document Analysis:** The tool will classify the document into categories such as 'Contract', 'Court Judgment', 'Patent', and more.")
