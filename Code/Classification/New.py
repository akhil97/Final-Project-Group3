...
#___________________Packages____________________________________________________________________________________

#give the path to the csv dataset
df = pd.read_csv('/home/ubuntu/NLP_Project/Code/Classification/Sentiment/Sentiment_Data/ILDC_multi.csv') # path to multi_dataset
...
# Update the function to use tqdm
...
#____________________________________________________________________________________________________________________
# Save the model
output_dir = '/home/ubuntu/NLP_Project/Code/Classification/Sentiment/'
